...
@store1.employees.create!(first_name: "Grindel", last_name: "Broume", hourly_rate: 24)

@store2.employees.create!(first_name: "Paul", last_name: "Peters", hourly_rate: 30)
...
@store2.employees.create!(first_name: "Tim", last_name: "Bow", hourly_rate: 13)
